...
{
   int rc, safe=0, thread1idx, thread2idx;
   ...
   printf("Creating thread %d\n", THREAD_1); thread1idx=THREAD_1;
   rc = pthread_create(&threads[0], NULL, grabRsrcs, (void *)&thread1idx);
   ...
   printf("Creating thread %d\n", THREAD_2); thread2idx=THREAD_2;
   rc = pthread_create(&threads[1], NULL, grabRsrcs, (void *)&thread2idx);
